...
return [
    ...
    | como as regras de tamanho. Sinta-se à vontade para ajustar cada uma aqui.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'A :attribute fornecida apareceu numa fuga de dados. Escolha outra diferente.',
    ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Aqui pode trocar o marcador de posição do atributo por algo mais
    | legível, como “Endereço de E-mail” em vez de “email”.
    |
    */
